...
namespace Gas_test2.Entities
{
   ...
   /// </summary>
   [Serializable()]
   [Table("EquipTypeSlet","选择设备种类表")]
   partial class EquipTypeSlet: DataEntity<EquipTypeSlet>, IDataEntity<EquipTypeSlet>
   {
       public EquipTypeSlet()
       {
       }
       
       protected EquipTypeSlet(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// EquipName 。
       /// </summary>
       [Column("EquipName","EquipName"),DataSize(10)]
       ...
       /// ETabName 。
       /// </summary>
       [Column("ETabName","ETabName"),DataSize(10),PrimaryKey,NotNull]
       [DisplayName("ETabName")]
       ...
       /// EquipNum 。
       /// </summary>
       [Column("EquipNum","EquipNum")]
       [DisplayName("EquipNum")]
       public int EquipNum
       {
           get;
           set;
