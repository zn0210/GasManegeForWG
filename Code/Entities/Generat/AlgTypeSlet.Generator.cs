...
{
   /// <summary>
   /// 实体对象 AlgTypeSlet(选择算法种类表)。
   /// </summary>
   [Serializable()]
   [Table("AlgTypeSlet","选择算法种类表")]
   partial class AlgTypeSlet: DataEntity<AlgTypeSlet>, IDataEntity<AlgTypeSlet>
   {
       public AlgTypeSlet()
       {
       }
       
       protected AlgTypeSlet(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// AlgName 。
       /// </summary>
       [Column("AlgName","AlgName"),DataSize(10)]
       [DisplayName("AlgName")]
       ...
       /// ATabName 。
       /// </summary>
       [Column("ATabName","ATabName"),DataSize(10),PrimaryKey,NotNull]
       [DisplayName("ATabName")]
