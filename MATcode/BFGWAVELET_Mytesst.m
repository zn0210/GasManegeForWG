...
load BWinput_testpreS;
load BWoutput_testS;
%预测输入归一化
x=mapminmax('apply',BWinput_testpreS,inputps);
x=x';
%网络预测
 for j=1:1:n
     for k=1:1:M
...
E=ynn-BWoutput_testS;
MSE=mse(E);
SSE=sse(E);
MAE=mae(E);
RE=E./BWoutput_testS;  %相对误差
...
hold on
plot(BWoutput_testS,'o-b','markerfacecolor','b','markersize',5);
